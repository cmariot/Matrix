...
/*   Updated: 2024/03/20 16:37:14 by cmariot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int m_complex_test(void)
{
    ...
    // Add
    {
        ...
        // ft::Matrix<std::complex<double>> ft_matrix1 = {
        ...
        // ft::Matrix<std::complex<double>> ft_matrix2 = {
        //     {std::complex<double>(1.0, 2.0), std::complex<double>(3.0, 4.0), std::complex<double>(5.0, 6.0)},
        //     {std::complex<double>(7.0, 8.0), std::complex<double>(9.0, 10.0), std::complex<double>(11.0, 12.0)},
        //     {std::complex<double>(13.0, 14.0), std::complex<double>(15.0, 16.0), std::complex<double>(17.0, 18.0)}
        // };

        // ft::Matrix<std::complex<double>> ft_result = ft_matrix1 + ft_matrix2;

        // std::cout << "ft_result: " << ft_result << std::endl;
    }
