...
int main()
{
    ft::Vector<double> i = {1, 0};  // length 1 pointing to the right
    ft::Vector<double> j = {0, 1};  // length 1 pointing upwards
    ...
    std::list<ft::Vector<double>> u = {i, j};  // list of vectors
    std::list<double> v = {2, 3};              // list of scalars

    try {
        ft::Vector<double> result = ft::linear_combination(u, v);
