...
class TestVector(unittest.TestCase):
    ...
    def test_linear_combination_with_valid_input(self):
        ...
        vectors = [v1, v2]
        coeffs = [2, 3]
        result = Vector.linear_combination(vectors, coeffs)
    ...
    def test_linear_combination_with_invalid_input(self):
        ...
        with self.assertRaises(TypeError) as context:
            Vector.linear_combination(v, coeffs)
        ...
        c = 2
        with self.assertRaises(TypeError) as context:
            Vector.linear_combination(vectors, c)
        ...
        with self.assertRaises(ValueError) as context:
            Vector.linear_combination(vectors, coeffs)
